<template>
    <div v-if="editor" class="d-flex flex-row align-items-center justify-content-center gap-2">
        ...
        <ul v-if="editor"class="nav nav-pills d-flex flex-row justify-content-center align-items-center gap-1">
            <li class="nav-item">
                <button
        ...
        <VDropdown v-if="editor">
            <ul class="nav nav-pills d-flex flex-row justify-content-center align-items-center gap-1">
                <li class="nav-item">
                    <button class="nav-link inactive btn-dark-gray" editor-cmd="advanced-palette">
